...
class AdminApi {
  ...
  async fetchRecipesNotPending(): Promise<FullRecipe[]> {
    try {
      ...
      throw handleApiError(error, 'Failed top fetch recipes not pending');
    }
  }
  ...
  async fetchPendingRecipes(): Promise<FullRecipe[]> {
    try {
      ...
      throw handleApiError(error, 'Failed to fetch pending recipes');
    }
  }
  ...
  async fetchMostFavoritedRecipe() {
    try {
      ...
      throw handleApiError(error, 'Failed to fetch most favorite recipe');
    }
  }
  ...
  async fetchMostLikedRecipe() {
    try {
      ...
      throw handleApiError(error, 'Failed to fetch most liked recipe');
    }
  }
